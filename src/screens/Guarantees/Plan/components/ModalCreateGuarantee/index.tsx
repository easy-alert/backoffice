...
interface IModalCreateGuarantee {
  systems: IGuaranteeSystem[];
  failureTypes: IGuaranteeFailureType[];
            ...
            <Form>
              ...
              <div>
                <ReactSelectComponent
                  ...
                  label="Falha(s) *"
                  options={failureTypes.map(({ id, name }) => ({ label: name, value: id }))}
                  value={values.failureTypesIds
                    ?.map((failureTypeId) => {
                      const failureType = failureTypes.find(({ id }) => id === failureTypeId);
                      return failureType
